...
def _worldbook_envelope(
    *,
    ...
    return {
        "v": 1,
        "id": entry_id,
        "body_ct": base64.b64encode(body_ct).decode("ascii"),
        "nonce": base64.b64encode(nonce).decode("ascii"),
        "K_user": crypto.b64(crypto.box_seal(key, user_pk)),
        "K_enclave": crypto.b64(crypto.box_seal(key, enclave_pk)),
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(f"base_url={args.base_url} provider={provider}")
